...
{
    public class Forum_S1MainTopicBranch1Controller : Controller
    {
        private ForumModels db = new ForumModels();

        // GET: Forum_S1MainTopicBranch1
        ...
        // GET: Forum_S1MainTopicBranch1/Details/5
        ...
        // GET: Forum_S1MainTopicBranch1/Create
        ...
        // POST: Forum_S1MainTopicBranch1/Create
        ...
        // GET: Forum_S1MainTopicBranch1/Edit/5
        ...
        // POST: Forum_S1MainTopicBranch1/Edit/5
        // 若要避免過量張貼攻擊，請啟用您要繫結的特定屬性。
        // 如需詳細資料，請參閱 https://go.microsoft.com/fwlink/?LinkId=317598。
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: Forum_S1MainTopicBranch1/Delete/5
        ...
        // POST: Forum_S1MainTopicBranch1/Delete/5
